...
export class GitPanelComponent implements OnInit {
  ...
  files: File[] = [
    ...
    {fileType: "md", fileName: "fileheader10.md", filePath: "/git-header.components/", fileStatus: "M", fileStaged: true, fileTracked: true},
    ...
    // {fileType: "md", fileName: "fileheader20.md", filePath: "/git-header.components/", fileStatus: "M", fileStaged: true, fileTracked: true},
  ...
  // 点击弹出菜单“全部提交”
  commitAllFiles(): void {
    console.log("Committing all files to server...");
    // 调用git status -> fetch data from server -> update file list panel
  }
